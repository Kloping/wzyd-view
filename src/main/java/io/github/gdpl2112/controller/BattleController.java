...
public class BattleController {
    ...
    public Object history(
        ...
        try {
            ...
            if (battleResult.getReturnCode() < 0) {
            ...
            int h = 2000;
            if (battleResult.getData().getList().size() < 12) {
                h = 500 + battleResult.getData().getList().size() * 120 + 60;
            }
            ...
            int index = 0;
            for (Object o : battleResult.getData().getList()) {
                if (index >= 12) break;
                JSONObject battle = (JSONObject) o;
                ...
                BattleHistory.BattleDetailResult battleDetailResult = battleHistory.getBattleDetail(
                        battle.getString("battleType"), battle.getString("gameSvrId"),
                        battle.getString("relaySvrId"), roleId, battle.getString("gameSeq"));
