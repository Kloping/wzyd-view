...
public class HttpApi {
    ...
    public Map<String, String> getRequestHeaders() {
        ...
        map.put("tinkerId", "2057965009_64_0");
        ...
        map.put("cSystemVersionName", "12");
        map.put("cSystemVersionCode", "31");
        ...
        map.put("cClientVersionName", "10.112.0603");
        map.put("cClientVersionCode", "2057965009");
